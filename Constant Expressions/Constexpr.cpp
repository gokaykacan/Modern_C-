...
2. Should contain only single line statement that should be a return statement (C++14 and later it is not necessary)
3. constexpr functions are implicitly inline
4. Use constexpr to create expressions that can be evaluated at compile time
*/